...
public class JavaMail {
    public static void sendMail(String recepient) throws Exception {
        ...
        String myAccountEmail = "ishanravidu975@gmail.com";
        String password = "Ishan00";
    ...
    private static Message prepareMessage(Session session,String myAccountEmail,String recepient) {
        try {
            ...
            message.setSubject("Welcome  System");
            message.setText("Wegards,\nTeam Matrix");
            return message;
        } catch (Exception ex) {
            System.out.println(JavaMail.class.getName());
        }
        return null;
    }
